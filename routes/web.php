...
Route::middleware(['auth'])->group(function () {
     ...
     * - Menampilkan hasil data latih (80% dari data)
     * - Menampilkan hasil data uji (20% dari data)
     ...
     * - Weekly Forecast: prediksi tinggi gelombang seminggu ke depan
     * 
    ...
    Route::prefix('hybrid')->name('hybrid.')->group(function () {
        ...
        Route::get('weekly-forecast', [App\Http\Controllers\HybridController::class, 'weeklyForecast'])->name('weekly-forecast'); // Prediksi seminggu ke depan
    });
});
