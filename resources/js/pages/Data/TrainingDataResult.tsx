 ...
 * 
 * Halaman ini menampilkan data latih (70% dari dataset) yang digunakan untuk pelatihan model.
            ...
            <div className="flex h-full flex-1 flex-col gap-6 overflow-x-auto p-6">
                ...
                <div className="space-y-1">
                    ...
                    <p className="text-sm text-neutral-600 dark:text-neutral-400">
                        Data latih (70% dari dataset) yang digunakan untuk pelatihan model ARIMAX dan Hybrid
                    </p>
                </div>
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-neutral-600 dark:text-neutral-400">
                                {totalData} data latih tersedia (70% dari total dataset)
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    {trainingData.data.length === 0 ? (
                        <div className="p-12 text-center">
                            ...
                            <p className="mt-1 text-sm text-neutral-500 dark:text-neutral-400">
                                Upload data terlebih dahulu untuk melihat data latih (70% dari dataset)
                            </p>
                        </div>
                    ) : (
                        <>
